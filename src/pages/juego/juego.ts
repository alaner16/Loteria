...
export class JuegoPage {
  ...
  tabla=[];
  user:any;
  constructor(public navCtrl: NavController,public tp: TableProvider, public partidaService: PartidaProvider, public navParams: NavParams, private modal: ModalController) {
  }
  ionViewWillLeave(){
